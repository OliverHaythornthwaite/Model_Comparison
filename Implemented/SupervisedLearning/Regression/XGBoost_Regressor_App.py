...
def xgboost_regression_page():
    st.sidebar.title("⚡ XGBoost Regression")
    ...
    st.title("⚡ XGBoost Regressor Demo")

    with st.expander("❓ What is XGBoost Regression?"):
        st.markdown("""
        **XGBoost** is an optimized implementation of Gradient Boosting.  
        ...
        ⚠️ More complex than plain Gradient Boosting  
        """)
