...
def lightgbm_page():
    st.sidebar.title("🌟 Supervised Learning (LightGBM Classifier)")
    ...
    max_depth = st.sidebar.slider("Max Depth", -1, 20, -1)  # -1 means no limit
    ...
    st.title("🌟 LightGBM Classifier Analysis")

    with st.expander("❓ What is LightGBM?"):
        st.markdown("""
        **LightGBM** (Light Gradient Boosting Machine) is a boosting framework optimized for speed and efficiency.  
